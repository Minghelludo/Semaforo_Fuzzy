...
def controlador_fuzzy(n_carros, tempo_carro, tempo_sinal, estado):
    ...
    #tempo minimo do sinal ficar aberto ou fechado
    if tempo_sinal < 10:
        return estado
    ...
    #declaração da variavel de quantidade de carros
    ...
    #declaração da variavel de tempo
    ...
    #declaração da saida fuzzy do estado do sinal
    ...
    #descobre se abre ou fecha o sinal
